...
private:
  ...
  /*  void handleRootFind(const std::vector<std::string>& tokens);
    ...
    */
    ...
    std::shared_ptr<Expression> parseAddSub(const std::string& expr,
                                            size_t& pos);
    std::shared_ptr<Expression> parseMulDiv(const std::string& expr,
                                            size_t& pos);
    std::shared_ptr<Expression> parsePower(const std::string& expr,
                                           size_t& pos);
    std::shared_ptr<Expression> parseFactor(const std::string& expr,
                                            size_t& pos);
    std::shared_ptr<Expression> parseNumber(const std::string& expr,
                                            size_t& pos);
