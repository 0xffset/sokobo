...
hidden if the `sokobo_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sokobo_DEVELOPER_MODE` to the configure
...
Runs the executable target `sokobo_exe`.
